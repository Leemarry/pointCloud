...
class GraphicManager {
   ...
   */
    ...
    beforeBeginCalc(id, polyArr, parameters, centerPoint = [113.36693330994926, 23.156426785188327], options = CesiumPolyline.defaultStyle) {
        ...
        //   },
        // });
        const material = Cesium.Color.fromCssColorString('rgba(0,255,0,0.8)');
        this.graphicType = GraphicType.POLYLINE;
   ...
   */
    ...
    // 计算中心点
        const centerX = (rectCorners[0][0] + rectCorners[1][0] + rectCorners[2][0] + rectCorners[3][0]) / 4;
        const centerY = (rectCorners[0][1] + rectCorners[1][1] + rectCorners[2][1] + rectCorners[3][1]) / 4;
        ...
        const clickHandler = function(e) {
          ...
          self.editManager.outlineGraphic.nodeGraphic
                ...
                if (pickedObj && known) {
                    ...
                    const positions = self.editManager.type === 'POLYGON' ? self.editManager.gobackpositions() : null
                    const type = self.editManager.mtype
   ...
   */
    ...
    import(feat) {
        const id = this.generateId();
        let graphic; let coordinates; const positions = [];
