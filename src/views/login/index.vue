        ...
        <div class="card-layout">
          <div id="card-right">
            <div class="right-top">
              ...
              <span style="color: aliceblue; font-size: 20px">系统</span>
            </div>
              ...
              <div id="login-form">
                <el-form :model="loginForm" label-width="100px" :rules="loginRules" ref="loginForm">
                  <el-form-item prop="username">
                    <el-input ref="username" prefix-icon="el-icon-user" v-model="loginForm.username" @change="changeUsername" placeholder="请输入用户名" name="username" type="text" tabindex="1" auto-complete="on" @keyup.enter.native="handelTab('password',$event)" />
                  </el-form-item>
                  <el-form-item prop="password" style="margin-bottom: 5px">
                    <!-- ref<< @paste.native.capture.prevent="handlePaste" -->
                    <el-input style="width: 300px" :key="passwordType" prefix-icon="el-icon-lock"  ref="password" v-model="loginForm.password" :type="passwordType" placeholder="请输入密码" name="password" tabindex="2" auto-complete="off" @keyup.enter.native="beforeLogin()" @click.native="clearPwd()" />
                  </el-form-item>
