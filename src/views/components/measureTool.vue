  ...
  methods: {
    creatDraw(type) {
      ...
      this.draw.on("drawend", e => {
        ...
        closeBtn.innerHTML = "×";
        closeBtn.title = "清除测量"
        closeBtn.style = "width: 20px;height:20px;line-height: 12px;text-align: center;border-radius: 5px;display: inline-block;padding: 2px;color: rgb(255, 68, 0);border: 2px solid rgb(255, 68, 0);background-color: rgb(255, 255, 255);font-weight: 600;position: absolute;top: -25px;right: -2px;cursor: pointer;";
