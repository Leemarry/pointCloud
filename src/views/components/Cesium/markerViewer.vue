        ...
        <div id="createMerkerPanel" v-if="markMode === 'marker'" v-show="visible">
            <el-container v-show="!selectPanel">
                <el-header>
                    ...
                    <span class="closebtn cesiumDrawFont iconclose" @click="visible = false"></span>
                </el-header>
                <el-container id="marker-panel">
                    <el-container>
                        <el-main class="marker-main-class">
                            <div class="pane-row">
                                <div>名称：</div>
                                <el-input v-model="markName" ref="nameinput" @keyup.enter="update"></el-input>
                            </div>
                    ...
                    <el-footer>
                        <el-button type="danger" id="cancelbtn" plain size="small" @click="cancelMark">删除</el-button>
                        <el-button type="primary" plain size="small" id="submitbtn" @click="update">确定</el-button>
                    </el-footer>
                </el-container>
            </el-container>
