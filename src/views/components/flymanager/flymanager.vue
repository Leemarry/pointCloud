 ...
 * @LastEditors: Andy
 * @LastEditTime: 2023-11-23 17:27:41
-->
<!-- 左侧面板 -->
<template>
    <div class='transition-out'>
          ...
          <div  class="left">
            ...
            <div  class="leftuav">
              ...
              <div class="parmitem">
                <div class="div">
                  {{ ProgressShow }}
                  <el-tooltip class="item" effect="dark" content="打开/关闭无人机电源" placement="right-start" >
              ...
              <div class="parmitem2">
                ...
                <el-row :gutter="20">
                  <el-col :span="6" class="parmName">
                    充电
                    <i class="el-icon-timer"  :title="getChargingTooltip()"></i>
                  </el-col>
                  <el-col :span="6" :style="'color:'+getChargingColor()">
                    ...
                    <el-tooltip class="item" effect="dark" content="开始/停止充电" placement="top-start">
                      <i  class="el-icon-loading" style="cursor:pointer" @click="startOrStopCharging()" ></i>
                  ...
                  <el-col :span="6" :style="'color:'+getRealdataWarn('remote')">
                    ...
                    <el-tooltip class="item" effect="dark" content="打开/关闭遥控器" placement="top-start" >
      ...
      <el-table :data="uavs" border height="300" @row-dblclick="clickUavItem" highlight-current-row :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}"  empty-text="没有拥有权限的无人机">
