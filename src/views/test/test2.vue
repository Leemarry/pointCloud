<template>
  <el-container>
    <el-main>
      ...
      <div class="viewer">
        <vc-viewer ref="viewer" scene3-d-only :animation="animation" :base-layer-picker="baseLayerPicker" :logo="false" :camera="camera" :l-e-f-t-c-l-i-c-k="mapLeftClick" @ready="ready">
          <vc-measure-distance ref="measureDistance" :clamp-to-ground="clampToGround" :remove-last-position="removeLastPosition" @activeEvt="activeEvt" @measureEvt="measureEvt" @movingEvt="movingEvt" />
          <vc-measure-area ref="measureArea" :clamp-to-ground="clampToGround" :remove-last-position="removeLastPosition" @activeEvt="activeEvt" @measureEvt="measureEvt" @movingEvt="movingEvt" />
