  ...
  <div v-loading="mixinsLoading" element-loading-background="rgba(0, 0, 0, 0.3)" class="media">
    <div class="media-top">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item label="文件类型">
          <el-select v-model="formInline.type" placeholder="请选择" style="width: 160px;" @change="changeType">
            <el-option v-for="item in reportOptions" :key="item.value" :label="item.label" :value="item.value" style="width: 220px;" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="时间范围">
          <el-col :span="12">
            <el-date-picker v-model="formInline.startTime" type="datetime" placeholder="选择起始时间" align="right" :picker-options="pickerOptions" style="width: 200px;" />
          </el-col>
          <el-col class="line" :span="2">至</el-col>
          <el-col :span="10">
            <el-date-picker v-model="formInline.endTime" type="datetime" placeholder="选择日期时间" default-time="12:00:00" style="width: 200px;" />
          </el-col>
        </el-form-item>
      </el-form>
      <div>
        ...
        <el-dropdown split-button type="primary" style="margin-left: 5px;" @click="uploadFiles(data)">
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item @click.native="uploadReport('塔线缺陷分析报告',{ fileType: 'line_analysis_report' , id : 0, reqUrl:'efapi/pointcloud/media/line_analysis_report/upload' })">塔线缺陷分析报告</el-dropdown-item>
            <el-dropdown-item @click.native="uploadReport('未区分',{ fileType: 'reports' , id : 0, reqUrl:'efapi/pointcloud/media/reports/upload' })">未区分</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
    </div>
    <div class="media-container">
      <el-table :data="tableData.slice((currentPage - 1) * pageSize, currentPage * pageSize)" stripe style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="towerMark" label="杆塔编号\文件夹" width="200">
          <template slot-scope="scope">
